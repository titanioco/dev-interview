...
import { AaveTransfer } from "../contracts/AaveTransfer.sol";
...
describe("AaveTransfer", function () {
  ...
  beforeEach(async function () {
    ...
    const MockVault = await ethers.getContractFactory("MockAaveCollateralVault");
  ...
  it("Should transfer collateral and loan positions", async function () {
    ...
    await mockVault.setTransferCollateralAndLoan(true);
  ...
  it("Should fail if transferCollateralAndLoan fails", async function () {
    ...
    await mockVault.setTransferCollateralAndLoan(false);
